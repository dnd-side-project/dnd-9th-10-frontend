...
export type StickerDtoNameEnum =
  (typeof StickerDtoNameEnum)[keyof typeof StickerDtoNameEnum];
...
export const MockApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    deleteBookmarkUsingDELETE: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("deleteBookmarkUsingDELETE", "id", id);
      const localVarPath = `/api/v1/bookmark/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    deleteDiaryUsingDELETE: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("deleteDiaryUsingDELETE", "id", id);
      const localVarPath = `/api/v1/friend/diary/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getDiaryUsingGET: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("getDiaryUsingGET", "id", id);
      const localVarPath = `/api/v1/friend/diary/detail/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateChecklistUsingPATCH: async (
      checklistInfoRequestDto?: ChecklistInfoRequestDto,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createBookmarkUsingPOST(
          bookmarkRequestDto,
          options
        );
     ...
     * @throws {RequiredError}
     */
    async deleteBookmarkUsingDELETE(
      id: number,
      options?: AxiosRequestConfig
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteBookmarkUsingDELETE(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteDiaryUsingDELETE(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async getBookmarksUsingGET(
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<DataResponseBookmarkInfoDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBookmarksUsingGET(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async getDiaryUsingGET(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<DataResponseGetDiaryResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDiaryUsingGET(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async getStickersUsingGET(
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<DataResponseDiaryStickerDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getStickersUsingGET(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async updateChecklistUsingPATCH(
      checklistInfoRequestDto?: ChecklistInfoRequestDto,
      options?: AxiosRequestConfig
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateChecklistUsingPATCH(
          checklistInfoRequestDto,
          options
        );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateDiaryUsingPATCH(
          id,
          createDiaryResponse,
          options
        );
...
export const MockApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createBookmarkUsingPOST(
      bookmarkRequestDto?: BookmarkRequestDto,
      options?: any
    ): AxiosPromise<MessageResponse> {
      return localVarFp
        .createBookmarkUsingPOST(bookmarkRequestDto, options)
     ...
     * @throws {RequiredError}
     */
    deleteBookmarkUsingDELETE(
      id: number,
      options?: any
    ): AxiosPromise<MessageResponse> {
      return localVarFp
        .deleteBookmarkUsingDELETE(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    deleteDiaryUsingDELETE(
      ...
      return localVarFp
        .deleteDiaryUsingDELETE(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    updateChecklistUsingPATCH(
      checklistInfoRequestDto?: ChecklistInfoRequestDto,
      options?: any
    ): AxiosPromise<MessageResponse> {
      return localVarFp
        .updateChecklistUsingPATCH(checklistInfoRequestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    updateDiaryUsingPATCH(
      id: number,
      createDiaryResponse?: CreateDiaryResponse,
      options?: any
    ): AxiosPromise<MessageResponse> {
      return localVarFp
        .updateDiaryUsingPATCH(id, createDiaryResponse, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class MockApi extends BaseAPI {
   ...
   * @memberof MockApi
   */
  public createBookmarkUsingPOST(
    bookmarkRequestDto?: BookmarkRequestDto,
    options?: AxiosRequestConfig
  ) {
   ...
   * @memberof MockApi
   */
  public updateChecklistUsingPATCH(
    checklistInfoRequestDto?: ChecklistInfoRequestDto,
    options?: AxiosRequestConfig
  ) {
    return MockApiFp(this.configuration)
